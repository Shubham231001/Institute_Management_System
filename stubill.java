	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getSource() == bopen) {
			try {
				...
				/*
				 * String id1=tFeet.getText(); int j=Integer.parseInt(id1);
				 * 
				 * String qry1= "select * from Course where co_id="+j+""; rs =
				 * st.executeQuery(qry1); while(rs.next()) { tconm.setText(rs.getString(2));
