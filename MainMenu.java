...
//exit
	...
	public void LaunchFrame() {
		...
		frame1.setTitle("MCA IT COURCES");
		...
		frame1.add(leli);
		/*
		 * Font fo=new Font("Monotype Corsiva" ,Font.BOLD,70); leli.setFont(fo);
		 * leli.setForeground(Color.red);
		 * 
		 * top=new JPanel(); top.setLayout(null);
		 * top.setBorder(BorderFactory.createEtchedBorder(1));
		 * top.setBackground(Color.pink); top.setBounds(0,10,1023,100); frame1.add(top);
		 * top.add(leli);
		 * 
		 * 
		 * lower=new JPanel(); lower.setLayout(null);
		 * lower.setBorder(BorderFactory.createEtchedBorder(1));
		 * lower.setBackground(Color.gray); lower.setBounds(0,105,1023,800);
		 * frame1.add(lower);
		 */
...
//TEACHER
		...
		/*
		 * deleteb.addActionListener(new ActionListener() { public void
		 * actionPerformed(ActionEvent ae) { if(ae.getSource()==deleteb) {
		 * 
		 * batrec op=new batrec(); } } });
		 * 
		 * 
		 * addb.addActionListener(new ActionListener() { public void
		 * actionPerformed(ActionEvent ae) { if(ae.getSource()==addb) {
		 * 
		 * batrec op=new batrec(); } } });
		 */
