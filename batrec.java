	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getSource() == bnew) {
			try {
				...
				/*
				 * //co_id.setEnabled(true); tconm.setEnabled(true); tcopd.setEnabled(true);
				 * 
		...
		if (ae.getSource() == bmod) {
			...
			try {
				...
				String str1 = "UPDATE Batch SET b_id ='" + tbcod1 + "',co_name='" + co_id1 + "',date1='" + tstrdt1
						+ "',time='" + ttime + "' where b_id LIKE '" + tbcod1 + "' ";
