...
class enqfrm extends JFrame implements ActionListener {
	...
	enqfrm() {
		...
		/*
		 * tfno.setEnabled(false); trno.setEnabled(false); tdate.setEnabled(false);
		 * tsname.setEnabled(false); tsadd.setEnabled(false); tspno.setEnabled(false);
		 * b_id.setEnabled(false); gender.setEnabled(false); co_id.setEnabled(false);
		 */
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getSource() == bnew) {
			try {
				 ...
				 * 
				 * tdate.setEnabled(true); tsname.setEnabled(true); tspno.setEnabled(true);
				 * b_id.setEnabled(true); tsadd.setEnabled(true); co_id.setEnabled(true);
				 */
