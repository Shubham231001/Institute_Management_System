	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getSource() == bmod) {
			...
			try {
				...
				String str1 = "UPDATE Teacher SET t_id ='" + tid1 + "',t_name='" + ttname1 + "',t_add='" + ttadd1
						+ "',Email_id='" + e1 + "',t_phno='" + ttpno1 + "',t_gender='" + g1 + "',co_id='" + c1
						+ "',b_id='" + b1 + "' where t_id LIKE '" + tid1 + "' ";
		...
		if (ae.getSource() == bopen) {
			try {
				...
				while (rs.next()) {
					...
					/*
					 * tgen.setText(rs.getString(5)); co_id.setText(rs.getString(6));
