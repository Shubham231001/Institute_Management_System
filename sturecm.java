	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getSource() == bcancel) {
			...
			try {
				...
				while (rs.next()) {
					model.insertRow(r++, new Object[] { rs.getString(3), rs.getString(4), rs.getString(6),
		...
		if (ae.getSource() == bmod) {
			...
			try {
				...
				String str1 = "UPDATE Admission SET Add_id =" + tfno1 + ",stu_name ='" + tsname1 + "',stu_add='"
						+ tsadd1 + "',Email_id='" + e1 + "',stu_phno='" + tspno1 + "',stu_gender='" + tgen1
						+ "'where Add_id=" + tfno1 + "";
